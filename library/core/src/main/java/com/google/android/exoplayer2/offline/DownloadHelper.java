...
public final class DownloadHelper {
  ...
  private static MediaSource createMediaSourceInternal(
    ...
    try {
      MediaSourceFactory factory = new DefaultMediaSourceFactory(dataSourceFactory, ExtractorsFactory.EMPTY);
    ...
    return factory.setDrmSessionManager(drmSessionManager)

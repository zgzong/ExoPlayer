...
public final class MimeTypes {
  ...
  public static final String IMAGE_GIF = BASE_TYPE_IMAGE + "/gif";
  public static final String IMAGE_JPEG = BASE_TYPE_IMAGE + "/jpeg";
  public static final String IMAGE_PNG = BASE_TYPE_IMAGE + "/png";
  public static final String IMAGE_SVG = BASE_TYPE_IMAGE + "/svg+xml";
  public static final String IMAGE_TIFF = BASE_TYPE_IMAGE + "/tiff";
